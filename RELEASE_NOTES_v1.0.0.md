# Web Scraper Pro v1.0.0

First public release of the Web Scraper Pro Chrome extension.

## Description

Web Scraper Pro is a Chrome extension to quickly extract structured data from web pages, using either guided CSS selector workflows or one-click quick scraping modes.
...
- Compatible with Chromium browsers (Chrome, Edge, Brave, Opera)
